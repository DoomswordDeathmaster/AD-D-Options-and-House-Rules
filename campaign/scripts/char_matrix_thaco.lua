...
function createTHACOMatrix()
  ...
  if bUseMatrix and not bisPC then 
    ...
    local fightsAs = AttackSaveMatricesAdndOpHr.getNpcFightsAs(node);

    Debug.console(sHitDice, node, fightsAs);
